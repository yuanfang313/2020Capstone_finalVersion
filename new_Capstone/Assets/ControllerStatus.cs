...
public class ControllerStatus : MonoBehaviour
{
    ...
    private bool rightControllerIsActive = false;
    private bool leftControllerIsActive = false;
    ...
    private void CheckForController()
    {
           ...
           OVRInput.IsControllerConnected(OVRInput.Controller.RTouch))
        {
            ...
            {
                controllerCheck = OVRInput.Controller.LTouch;
                leftControllerIsActive = true;
            }
            else if (changeController)
            {
                controllerCheck = OVRInput.Controller.RTouch;
                rightControllerIsActive = true;
            }
        }
    ...
    {
      if(leftControllerIsConnected || leftControllerIsActive)
        {
      ...
      if(rightControllerIsConnected || rightControllerIsActive)
        {
